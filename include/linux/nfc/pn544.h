...
#define PN544_HOST_INT_GPIO		29
#define PN544_ENABLE_GPIO		30
#define PN544_FW_RESET_GPIO		26
...
typedef struct chip_tset_data_t {
	struct chip_data_t chip_version;
	union pn544_value loop_tolerance;
	union pn544_value selftest_threshold;
} chip_tset_data_t;

extern struct chip_tset_data_t pn544_test_info;
