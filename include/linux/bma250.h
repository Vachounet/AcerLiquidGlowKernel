...
#define BMA250_EN_HIGHG_XYZ_INT__MSK       0x07
...
struct bma250_data {
	...
	struct gsensor_cal_data	cal_data;
	struct gsensor_cal_data	cal_fa_data;
...
#define GSENSOR_IOC_MAGIC       'g' 

#define GSENSOR_IOC_ENABLE      _IO(GSENSOR_IOC_MAGIC, 1)
#define GSENSOR_IOC_DISABLE     _IO(GSENSOR_IOC_MAGIC, 2)
#define GSENSOR_IOC_GET_ACCEL   _IOR(GSENSOR_IOC_MAGIC, 3, struct bma250acc)
#define GSENSOR_IOC_SET_CALDAT	_IOW(GSENSOR_IOC_MAGIC, 4, struct gsensor_cal_data)
#define GSENSOR_IOC_CALIBRATION _IOR(GSENSOR_IOC_MAGIC, 5, struct gsensor_cal_data)
#define GSENSOR_IOC_GET_CHIPID  _IOR(GSENSOR_IOC_MAGIC, 6, unsigned char)
#define GSENSOR_IOC_SET_DELAY  _IOR(GSENSOR_IOC_MAGIC, 7, unsigned short)
#define GSENSOR_IOC_GET_RANGE  _IOR(GSENSOR_IOC_MAGIC, 8, unsigned short)
#define GSENSOR_IOC_UPDATE_CAL_DATA _IOR(GSENSOR_IOC_MAGIC, 9, struct gsensor_cal_data)
#endif