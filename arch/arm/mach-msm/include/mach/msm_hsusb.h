...
enum chg_type {
	...
	USB_CHG_TYPE__OTHERWALLCHARGER, 
	USB_CHG_TYPE__FASTERCHARGER 
};
...
struct msm_otg_chg_notify {
	
	void (*msm7x27a_chg_connected)(enum chg_type chg_type);
	void (*msm7x27a_chg_vbus_draw)(unsigned ma);

	unsigned int (*msm7x27a_get_batt_capacity)(void);
