...
static unsigned int keypad_row_gpios[] = {};
static unsigned int keypad_col_gpios[] = { 35, 36 };
...
#define FFA_7K_KEYMAP_INDEX(row, col) ((row)*ARRAY_SIZE(keypad_col_gpios) + (col))
static const unsigned short keypad_keymap_ffa[ARRAY_SIZE(keypad_col_gpios)] = {
	[FFA_7K_KEYMAP_INDEX(0, 0)] = KEY_VOLUMEUP,	
	[FFA_7K_KEYMAP_INDEX(0, 1)] = KEY_VOLUMEDOWN,	
};
#if 0
static const unsigned short keypad_keymap_ffa[ARRAY_SIZE(keypad_col_gpios) *
					      ARRAY_SIZE(keypad_row_gpios)] = {
