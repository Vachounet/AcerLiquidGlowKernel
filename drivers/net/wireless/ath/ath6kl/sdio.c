...
#define AR6003_SDIO_DMA_LEN    SZ_32K
extern void *addr_ar6003_sdio_dma;
#endif
...
static int ath6kl_sdio_suspend(struct ath6kl *ar, struct cfg80211_wowlan *wow)
{
	...
	if (ar->suspend_mode == WLAN_POWER_STATE_WOW ||
		...
		ath6kl_dbg(ATH6KL_DBG_SUSPEND, "wow is in progress\n");
	...
	if (ar->suspend_mode == WLAN_POWER_STATE_DEEP_SLEEP ||
		...
		ath6kl_dbg(ATH6KL_DBG_SUSPEND, "deep sleep is in progress\n");
...
#ifdef CONFIG_WLAN_ALLOC_STATIC_MEM
	memset(addr_ar6003_sdio_dma, 0, AR6003_SDIO_DMA_LEN);
	if (addr_ar6003_sdio_dma != NULL)
		ar_sdio->dma_buffer = addr_ar6003_sdio_dma;
	else {
		ret = -ENOMEM;
		goto err_hif;
	}
